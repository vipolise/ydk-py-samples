...
"""
Update config for model Cisco-IOS-XR-ip-ntp-cfg.

usage: nc-update-config-ip-ntp-10-ydk.py [-h] [-v] device
...
if __name__ == "__main__":
    ...
    # crud.update(provider, ntp)  # update object on NETCONF device
    provider.close()
    exit()
# End of script
