...
"""
Create config for model Cisco-IOS-XR-crypto-macsec-mka-cfg.

usage: nc-create-config-crypto-macsec-mka-10-ydk.py [-h] [-v] device
...
if __name__ == "__main__":
    ...
    # crud.create(provider, mac_sec)  # create object on NETCONF device
    provider.close()
    exit()
# End of script
