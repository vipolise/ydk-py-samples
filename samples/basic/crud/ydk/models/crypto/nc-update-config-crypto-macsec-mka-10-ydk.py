...
"""
Update config for model Cisco-IOS-XR-crypto-macsec-mka-cfg.

usage: nc-update-config-crypto-macsec-mka-10-ydk.py [-h] [-v] device
...
if __name__ == "__main__":
    ...
    # crud.update(provider, mac_sec)  # update object on NETCONF device
    provider.close()
    exit()
# End of script
