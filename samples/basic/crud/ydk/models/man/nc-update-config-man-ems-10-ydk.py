...
"""
Update config for model Cisco-IOS-XR-man-ems-cfg.

usage: nc-update-config-man-ems-10-ydk.py [-h] [-v] device
...
if __name__ == "__main__":
    ...
    # crud.update(provider, grpc)  # update object on NETCONF device
    provider.close()
    exit()
# End of script
