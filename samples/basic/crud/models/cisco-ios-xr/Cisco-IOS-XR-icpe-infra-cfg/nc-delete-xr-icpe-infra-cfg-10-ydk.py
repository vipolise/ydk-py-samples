...
"""
Delete all config data for model Cisco-IOS-XR-icpe-infra-cfg.

usage: nc-delete-xr-icpe-infra-cfg-10-ydk.py [-h] [-v] device
...
if __name__ == "__main__":
    ...
    # crud.delete(provider, nv_satellite_global)
