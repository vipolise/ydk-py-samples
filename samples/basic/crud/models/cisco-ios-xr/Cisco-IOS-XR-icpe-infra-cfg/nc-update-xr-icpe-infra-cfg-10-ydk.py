...
"""
Update configuration for model Cisco-IOS-XR-icpe-infra-cfg.

usage: nc-update-xr-icpe-infra-cfg-10-ydk.py [-h] [-v] device
...
if __name__ == "__main__":
    ...
    # crud.update(provider, nv_satellite_global)
