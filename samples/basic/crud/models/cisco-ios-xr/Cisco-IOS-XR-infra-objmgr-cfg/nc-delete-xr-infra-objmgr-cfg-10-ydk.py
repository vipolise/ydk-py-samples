...
"""
Delete all config data for model Cisco-IOS-XR-infra-objmgr-cfg.

usage: nc-delete-xr-infra-objmgr-cfg-10-ydk.py [-h] [-v] device
...
if __name__ == "__main__":
    ...
    # crud.delete(provider, object_group)
