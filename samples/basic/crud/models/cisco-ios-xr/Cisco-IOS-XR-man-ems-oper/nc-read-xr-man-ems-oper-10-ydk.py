...
usage: nc-read-xr-man-ems-oper-10-ydk.py [-h] [-v] device
...
from ydk.models.cisco_ios_xr import Cisco_IOS_XR_man_ems_oper \
    as xr_man_ems_oper
import logging
...
if __name__ == "__main__":
    ...
    grpc = xr_man_ems_oper.Grpc()  # create object
