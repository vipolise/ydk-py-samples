...
"""
Read all data for model Cisco-IOS-XR-ipv4-acl-oper.

usage: nc-read-xr-ipv4-acl-oper-10-ydk.py [-h] [-v] device
...
from ydk.models.cisco_ios_xr import Cisco_IOS_XR_ipv4_acl_oper \
    as xr_ipv4_acl_oper
import logging
...
if __name__ == "__main__":
    ...
    ipv4_acl_and_prefix_list = xr_ipv4_acl_oper.Ipv4AclAndPrefixList()  # create object
