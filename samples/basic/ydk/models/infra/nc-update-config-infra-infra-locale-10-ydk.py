...
"""
Update config for model Cisco-IOS-XR-infra-infra-locale-cfg.

usage: nc-update-config-infra-infra-locale-10-ydk.py [-h] [-v] device
...
if __name__ == "__main__":
    ...
    # crud.update(provider, locale)  # update object on NETCONF device
    provider.close()
    exit()
# End of script
